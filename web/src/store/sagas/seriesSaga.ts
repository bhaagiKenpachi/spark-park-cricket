...
// import { Series } from '../reducers/seriesSlice'; // Not used in this file
import { ApiService, ApiError } from '@/services/api';

export function* fetchSeriesSaga(): Generator<any, void, any> {
    try {
...
export function* createSeriesSaga(action: ReturnType<typeof createSeriesRequest>): Generator<any, void, any> {
    try {
        const apiService = new ApiService();
...
export function* updateSeriesSaga(action: ReturnType<typeof updateSeriesRequest>): Generator<any, void, any> {
    try {
        const apiService = new ApiService();
...
export function* deleteSeriesSaga(action: ReturnType<typeof deleteSeriesRequest>): Generator<any, void, any> {
    try {
        const apiService = new ApiService();
