...
export default function GroupsPage(): React.JSX.Element {
    ...
    const handleEditGroup = (group: GroupWithCreator) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <h1 className="text-base font-bold text-gray-900">
                                    ...
                                    {viewMode === 'create' && 'Create Group'}
                                    {viewMode === 'edit' && 'Edit Group'}
                        ...
                        {viewMode === 'list' && (
                            <Button
                                ...
                                size="sm"
                                className="flex items-center gap-1 h-8 px-3 bg-blue-600 hover:bg-blue-700"
                            >
            ...
            <main className="w-full max-w-md mx-auto px-3 py-3">
                {viewMode === 'list' && (
                    <GroupList
