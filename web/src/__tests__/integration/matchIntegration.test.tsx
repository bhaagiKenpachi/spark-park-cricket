...
import { matchSlice, createMatchRequest, updateMatchRequest } from '../../store/reducers/matchSlice';
...
jest.mock('../../store/reducers/matchSlice', () => ({
    ...
    createMatchRequest: jest.fn().mockReturnValue({ type: 'match/createMatchRequest' }),
    updateMatchRequest: jest.fn().mockReturnValue({ type: 'match/updateMatchRequest' }),
}));
...
describe('Match Integration Tests', () => {
    ...
    describe('Match CRUD Operations Integration', () => {
        it('should complete create match workflow', async () => {
            ...
            render(
                <Provider store={mockStore}>
                    <MatchForm seriesId="series-1" onSuccess={jest.fn()} onCancel={jest.fn()} />
                </Provider>
            );
        ...
        it('should complete edit match workflow', async () => {
            ...
            render(
                <Provider store={mockStore}>
                    <MatchForm match={mockMatch} onSuccess={jest.fn()} onCancel={jest.fn()} />
                </Provider>
            );
