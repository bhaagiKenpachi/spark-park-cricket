...
describe('Scorecard Integration Tests', () => {
    ...
    describe('Scorecard CRUD Operations Integration', () => {
        ...
        it('should handle ball with byes scoring workflow', async () => {
            ...
            await waitFor(() => {
                expect(apiService.addBall).toHaveBeenCalledWith(expectedBallWithByesEvent);
            });
        });
    });
    ...
    describe('Error Handling Integration', () => {
        it('should handle API errors gracefully', async () => {
            ...
            (apiService.getScorecard as jest.Mock).mockRejectedValueOnce(new Error('API Error'));
        ...
        it('should handle start scoring errors', async () => {
            ...
            (apiService.startScoring as jest.Mock).mockRejectedValueOnce(new Error('Match not ready'));
        ...
        it('should handle add ball errors', async () => {
            ...
            (apiService.addBall as jest.Mock).mockRejectedValueOnce(new Error('Invalid ball data'));
        ...
        it('should handle innings completion errors', async () => {
            ...
            (apiService.addBall as jest.Mock).mockRejectedValueOnce(new Error('Innings already completed'));
