...
describe('Scorecard Sagas', () => {
    ...
    describe('fetchScorecardSaga', () => {
        ...
        it('should fetch scorecard successfully', async () => {
            ...
            await runSaga(mockStore, fetchScorecardSaga, fetchScorecardRequest('match-1')).toPromise();

            expect(mockApiService.getScorecard).toHaveBeenCalledWith('match-1');
            expect(dispatched).toContainEqual(fetchScorecardSuccess(mockScorecardData));
        });
        ...
        it('should handle API errors', async () => {
            ...
            expect(dispatched).toContainEqual(fetchScorecardFailure('Scorecard not found'));
        });

        it('should handle generic errors', async () => {
            mockApiService.getScorecard.mockRejectedValueOnce(new Error('Network error'));

            await runSaga(mockStore, fetchScorecardSaga, fetchScorecardRequest('match-1')).toPromise();

            expect(dispatched).toContainEqual(fetchScorecardFailure('Failed to fetch scorecard'));
        });
    ...
    describe('startScoringSaga', () => {
        it('should start scoring successfully', async () => {
            ...
            await runSaga(mockStore, startScoringSaga, startScoringRequest('match-1')).toPromise();
        ...
        it('should handle start scoring API errors', async () => {
            ...
            expect(dispatched).toContainEqual(startScoringFailure('Match is not ready for scoring'));
        });

        it('should handle start scoring generic errors', async () => {
            mockApiService.startScoring.mockRejectedValueOnce(new Error('Network error'));

            await runSaga(mockStore, startScoringSaga, startScoringRequest('match-1')).toPromise();

            expect(dispatched).toContainEqual(startScoringFailure('Failed to start scoring'));
        });
    });
    ...
    describe('addBallSaga', () => {
        ...
        it('should add ball successfully', async () => {
            ...
            await runSaga(mockStore, addBallSaga, addBallRequest(mockBallEvent)).toPromise();
        ...
        it('should add wicket ball successfully', async () => {
            ...
            await runSaga(mockStore, addBallSaga, addBallRequest(wicketBallEvent)).toPromise();
        ...
        it('should add wide ball successfully', async () => {
            ...
            await runSaga(mockStore, addBallSaga, addBallRequest(wideBallEvent)).toPromise();
        ...
        it('should add no ball successfully', async () => {
            ...
            await runSaga(mockStore, addBallSaga, addBallRequest(noBallEvent)).toPromise();
        ...
        it('should add ball with byes successfully', async () => {
            ...
            await runSaga(mockStore, addBallSaga, addBallRequest(ballWithByes)).toPromise();
        ...
        it('should handle innings completion error', async () => {
            ...
            expect(dispatched).toContainEqual(addBallFailure('Innings already completed'));
        });
    });
    ...
    describe('fetchInningsSaga', () => {
        ...
        it('should fetch innings successfully', async () => {
            ...
            await runSaga(mockStore, fetchInningsSaga, fetchInningsRequest({ matchId: 'match-1', inningsNumber: 1 })).toPromise();
        ...
        it('should handle fetch innings API errors', async () => {
            ...
            expect(dispatched).toContainEqual(fetchInningsFailure('Innings not found'));
        });

        it('should handle fetch innings generic errors', async () => {
            mockApiService.getInnings.mockRejectedValueOnce(new Error('Network error'));

            await runSaga(mockStore, fetchInningsSaga, fetchInningsRequest({ matchId: 'match-1', inningsNumber: 1 })).toPromise();

            expect(dispatched).toContainEqual(fetchInningsFailure('Failed to fetch innings'));
        });
