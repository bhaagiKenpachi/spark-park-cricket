...
describe('Match Saga Tests', () => {
    ...
    describe('fetchMatchesSaga', () => {
        ...
        it('should handle generic errors', async () => {
            ...
            expect(dispatched).toContainEqual(fetchMatchesFailure('Failed to fetch matches'));
        });
    });
    ...
    describe('createMatchSaga', () => {
        ...
        it('should handle API errors', async () => {
            ...
            expect(dispatched).toContainEqual(createMatchFailure('Validation failed'));
        });
        ...
        it('should handle generic errors', async () => {
            ...
            expect(dispatched).toContainEqual(createMatchFailure('Failed to create match'));
        });
    });
    ...
    describe('updateMatchSaga', () => {
        it('should update match successfully', async () => {
            ...
            expect(mockApiService.updateMatch).toHaveBeenCalledWith(matchId, matchData);
        ...
        it('should handle generic errors', async () => {
            ...
            expect(dispatched).toContainEqual(updateMatchFailure('Failed to update match'));
        });
    });
    ...
    describe('deleteMatchSaga', () => {
        ...
        it('should handle generic errors', async () => {
            ...
            expect(dispatched).toContainEqual(deleteMatchFailure('Failed to delete match'));
        });
    });
