...
export function SeriesWithMatches({ series, onEditSeries, onDeleteSeries, onViewScorecard }: SeriesWithMatchesProps): React.JSX.Element {
    const dispatch = useAppDispatch();
    const { matches, loading: matchesLoading, error: matchesError } = useAppSelector((state) => state.match);
                ...
                {expanded && (
                    <div className="mt-6">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold">Matches ({seriesMatches.length})</h3>
