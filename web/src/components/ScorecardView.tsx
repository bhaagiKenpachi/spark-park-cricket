...
import { LiveMatchUpdates } from '@/components/sse/LiveMatchUpdates';
...
export function ScorecardView({
  ...
  const [activeTab, setActiveTab] = useState<'scorecard' | 'live-updates'>('scorecard');
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6">
        ...
        <div className="flex justify-center">
          <div className="flex bg-gray-100 rounded-lg p-1">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'scorecard'
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeTab === 'live-updates'
                  ? 'bg-white text-gray-900 shadow-sm'
                  : 'text-gray-600 hover:text-gray-900'
                }`}
            >
      ...
      {activeTab === 'live-updates' ? (
        <LiveMatchUpdates
          matchId={matchId}
          enabled={scorecardData.match_status === 'live'}
        />
      ) : (
        <>
