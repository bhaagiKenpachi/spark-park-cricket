describe('Scorecard Management E2E Tests', () => {
    ...
    describe('Scorecard Display', () => {
        it('should display scorecard on page load', () => {
            ...
            cy.get('[data-cy="scorecard-header"]').should('contain', 'Test Series - Match #1');
    ...
    describe('Error Handling', () => {
        ...
        it('should handle start scoring error', () => {
            ...
            cy.get('[data-cy="error-message"]').should('contain', 'Match is not ready for scoring');
        });
        ...
        it('should handle add ball error', () => {
            ...
            cy.get('[data-cy="error-message"]').should('contain', 'Invalid ball data');
        });
        ...
        it('should handle innings completion error', () => {
            ...
            cy.get('[data-cy="error-message"]').should('contain', 'Innings already completed');
        });
    });
    ...
    describe('Loading States', () => {
        it('should show loading state during scorecard fetch', () => {
            ...
            cy.get('[data-cy="loading-text"]').should('contain', 'Loading scorecard...');
    ...
    describe('Match Status Handling', () => {
        it('should handle scheduled match status', () => {
            ...
            cy.get('[data-cy="match-ready-message"]').should('contain', 'Match ready to start');
        });
                        ...
                        innings: [
                            {
                                ...
                                total_balls: 120,
                                status: 'completed',
                                extras: { byes: 5, leg_byes: 2, wides: 8, no_balls: 1, total: 16 },
                                overs: [],
                            },
                            {
                                innings_number: 2,
                                ...
                                total_balls: 114,
                                status: 'completed',
                                extras: { byes: 3, leg_byes: 1, wides: 6, no_balls: 2, total: 12 },
                                overs: [],
                            },
                        ],
                    },
