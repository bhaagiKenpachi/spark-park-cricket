describe('Match Management E2E Tests', () => {
  ...
  it('should edit an existing match', () => {
    ...
    cy.get('[data-cy=match-item]')
      .first()
      .find('[data-cy=edit-match-button]')
      .click();
  ...
  it('should delete a match', () => {
    ...
    cy.get('[data-cy=match-item]')
      .first()
      .find('[data-cy=delete-match-button]')
      .click();
  ...
  it('should validate required fields', () => {
    ...
    cy.get('[data-cy=error-message]').should(
      'contain',
      'Team player count is required'
    );
    cy.get('[data-cy=error-message]').should(
      'contain',
      'Total overs is required'
    );
  });
  ...
  it('should validate data ranges', () => {
    ...
    cy.get('[data-cy=error-message]').should(
      'contain',
      'Team player count must be between 1 and 11'
    );
    cy.get('[data-cy=error-message]').should(
      'contain',
      'Total overs must be between 1 and 20'
    );
  });
  ...
  it('should be responsive on mobile devices', () => {
    ...
    cy.get('[data-cy=create-match-button]').should(
      'have.css',
      'min-height',
      '44px'
    );
