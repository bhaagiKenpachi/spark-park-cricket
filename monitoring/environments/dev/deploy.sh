...
# Development Environment Monitoring Deployment Script
# Deploys Prometheus and Grafana for cricket-dev.dojima.foundation
...
# Configuration
ENVIRONMENT="dev"
DOMAIN="cricket-dev.dojima.foundation"
