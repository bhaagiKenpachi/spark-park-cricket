...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE dev_v1.votes 
        ADD COLUMN team_formation_enabled BOOLEAN NOT NULL DEFAULT true;
        
        -- Add comment to explain the column
        COMMENT ON COLUMN dev_v1.votes.team_formation_enabled IS 'Controls whether team formation is enabled for this vote. When true, users can create and manage teams from voted users.';
    END IF;
END $$;
...
UPDATE dev_v1.votes SET team_formation_enabled = true WHERE team_formation_enabled IS NULL;
