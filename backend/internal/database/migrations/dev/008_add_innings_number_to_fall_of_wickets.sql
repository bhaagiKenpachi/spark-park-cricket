...
ALTER TABLE dev_v1.fall_of_wickets 
...
UPDATE dev_v1.fall_of_wickets 
SET innings_number = (
    SELECT innings_number 
    FROM dev_v1.innings 
    WHERE dev_v1.innings.id = dev_v1.fall_of_wickets.innings_id
);
...
CREATE INDEX IF NOT EXISTS idx_fall_of_wickets_innings_number ON dev_v1.fall_of_wickets(innings_number);

-- Add comment for documentation
COMMENT ON COLUMN dev_v1.fall_of_wickets.innings_number IS 'Innings number (1 or 2) when the wicket fell';
