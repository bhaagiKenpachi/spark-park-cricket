...
type MatchRepository interface {
	...
	GetNextMatchNumber(ctx context.Context, seriesID string) (int, error)
	ExistsBySeriesAndMatchNumber(ctx context.Context, seriesID string, matchNumber int) (bool, error)
}
